...
export const PRODUCTS = [
  ...
  {
    id: "prod-9",
    name: "Raytools BM11 Auto-Focus Laser Cutting",
    category: "Cutting Heads",
  ...
  {
    id: "prod-10",
    name: "0.8mm to 6mm dubble & single Rs 250",
    category: "Cutting Heads",
  ...
  {
    id: "prod-11",
    name: "SMC 10 bar components refer to a broad ",
    category: "WSX Laser Cutting Head",
    compatibleBrands: ["Raytools", "Precitec", "BOCI", "Friendess", "WSX"],
    shortDesc: "Quality SMC pneumatic automation equipment designed for reliable industrial networks operating up to 10 bar.",
    ...
    badge: "In Stock",
    pricePlaceholder: "₹ 14,000 - 15,000 / Unit",
  ...
  {
    id: "prod-12",
    name: "Raytools Wireless Handheld Remote Controller",
    category: "Consumables & Maintenance",
    compatibleBrands: ["Raycus", "MAX Photonics", "IPG Photonics"],
    shortDesc: "XC3000S control system designed for precise, reliable operation of high-performance industrial fiber laser cutting machines.",
    ...
    badge: "Maintenance",
    pricePlaceholder: "₹ 15,500 Single Unit",
  ...
  {
    id: "prod-13",
    name: "Raytools CNC Wireless Remote Controller",
    category: "Consumables & Maintenance",
    compatibleBrands: ["Raytools", "Precitec", "BOCI", "WSX", "Raycus", "MAX Photonics"],
    shortDesc: "WUR600 wireless receiver with magnetic-base antenna provides reliable wireless communication connectivity.",
