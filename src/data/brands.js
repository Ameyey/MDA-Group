export const BRANDS = [
    ...
    svgLogo: (
      <svg viewBox="0 0 200 60" className="w-32 h-10">
        <text x="10" y="38" fill="currentColor" fontSize="28" fontWeight="800" letterSpacing="1" fontFamily="sans-serif">
          RAY<tspan fill="#0284c7">TOOLS</tspan>
        </text>
        <path d="M165 15 L185 30 L165 45 Z" fill="#0284c7" />
      </svg>
    )
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 220 60" className="w-36 h-10">
        <text x="5" y="38" fill="#0284c7" fontSize="30" fontWeight="900" fontFamily="sans-serif">
          MAX <tspan fill="#ef4444" fontSize="22" fontWeight="700">PHOTONICS</tspan>
        </text>
        <circle cx="198" cy="25" r="8" fill="#ef4444" />
      </svg>
    )
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 200 60" className="w-32 h-10">
        <path d="M10 18 L25 18 L35 32 L45 18 L60 18 L42 42 L28 42 Z" fill="#1d4ed8" />
  ...
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 180 60" className="w-28 h-10">
        <rect x="10" y="15" width="30" height="30" rx="6" fill="#06b6d4" />
        <text x="18" y="38" fill="#ffffff" fontSize="20" fontWeight="900">B</text>
  ...
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 210 60" className="w-34 h-10">
        ...
        <circle cx="165" cy="22" r="6" fill="#0f766e" />
      </svg>
    )
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 220 60" className="w-36 h-10">
        <rect x="10" y="14" width="45" height="28" rx="4" fill="#f97316" />
        <text x="16" y="35" fill="#ffffff" fontSize="18" fontWeight="900">IPG</text>
    ...
    svgLogo: (
      <svg viewBox="0 0 220 60" className="w-36 h-10">
        <text x="10" y="38" fill="currentColor" fontSize="24" fontWeight="800" fontFamily="sans-serif">
          Han's <tspan fill="#dc2626">LASER</tspan>
        </text>
      </svg>
    )
  },
    ...
    svgLogo: (
      <svg viewBox="0 0 230 60" className="w-40 h-10">
        <text x="5" y="38" fill="currentColor" fontSize="24" fontWeight="800">
          FSCUT <tspan fill="#2563eb" fontSize="16" fontWeight="600">(Friendess)</tspan>
        </text>
      </svg>
    )
  },
  {
    ...
    svgLogo: (
      <svg viewBox="0 0 180 60" className="w-28 h-10">
        <text x="10" y="38" fill="#0284c7" fontSize="28" fontWeight="900" letterSpacing="1">
          OSPRI
        </text>
      </svg>
    )
